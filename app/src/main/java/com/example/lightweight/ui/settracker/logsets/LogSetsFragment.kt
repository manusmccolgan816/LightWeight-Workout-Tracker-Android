...
//            val reps = editTextNumReps.text.toString().toInt()
//            // If weight and reps have been input...
//            if (weight != null && reps != null) {
//                var workout = Workout(date, null)
...
//                val exerciseID = setTrackerActivity.exerciseID
//                // TODO Change this of course
//                var exerciseInstance: ExerciseInstance = ExerciseInstance(1, 1, null)
...
//                val trainingSet: TrainingSet = TrainingSet(exerciseInstance.exerciseInstanceID, weight, reps, null, false)
